...
// ─── 3. ตัวกรองเสื้อผ้าผู้หญิง v3 ────────────────────────────────────────────
const pass = (c1: string, c2 = "", c3 = "") => classifyWomenFashion(c1, c2, c3).pass;
...
check("ไม่ผ่าน: Women Shoes (รองเท้า)", !pass("Women Shoes", "Wedges"));
check("ไม่ผ่าน: Women Bags (กระเป๋า)", !pass("Women Bags"));
